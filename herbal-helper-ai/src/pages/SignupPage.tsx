...
import { ArrowRight, Lock, Mail, User, AlertTriangle, Eye, EyeOff } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Header */}
          <span className="adaline-micro block mb-3" style={{ color: "var(--color-moss-veil)" }}>Join PlantSage</span>
          <h1
          ...
          >
            Create an account to save identified plants, document herb coordinates, and plan home gardens.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 opacity-50 text-cream-paper" />
                <input
                  type="text"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  placeholder="Elara Varma"

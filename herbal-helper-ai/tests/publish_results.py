...
def main():
    ...
    markdown_output = []
    markdown_output.append("# 🧪 PlantSage AI Automated Test Verification Dashboard\n")
    ...
    markdown_output.append("<details><summary>Click to view all E2E Test Cases (136 tests)</summary>\n")
    ...
    full_markdown = "\n".join(markdown_output).replace("VanaVaidhya", "PlantSage AI").replace("PlantSage AI Website - ", "PlantSage AI - ")

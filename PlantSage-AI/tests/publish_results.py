...
def main():
    ...
    e2e_path = os.path.join(tests_dir, "reports", "E2E_Test_Report_PlantSage_AI_2026-06-11T11-21-10.xlsx")
    sec_path = os.path.join(tests_dir, "reports", "Security_Vulnerabilities_Report_v3.xlsx")
